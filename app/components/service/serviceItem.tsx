...
export default function ServiceItem() {
  return (
    <div className="rounded-lg border-brandOrange bg-brandOrange border w-26">
      <div className="p-5 text-white flex flex-col">
        <svg
          ...
          viewBox="0 0 207.464 207.464"
          className="justify-self-center self-center"
        >
          <path
            d="M200.037,116.548l-0.489-0.454c-0.299-0.275-0.598-0.551-0.886-0.839l-46.604-46.591c-0.102-0.102-0.208-0.199-0.319-0.292
	...
	C108.145,46.082,106.865,46.57,105.585,46.57z"
        ...
        <h3 className="text-2xl justify-center self-center py-3 font-semibold">Service Name</h3>
        <p className="text-l justify-self-center content-center m-auto text-white">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus
          impedit molestias voluptate similique distinctio veritatis natus
          obcaecati accusantium esse illum! Numquam id repellendus sequi
          excepturi magni cum error dolores illum.
        </p>
      </div>
    </div>
  );
